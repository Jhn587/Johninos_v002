...
import { createOrderStatus } from "../graphql/mutations";
export default function OrderStatusCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createOrderStatus.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OrderStatusCreateForm")}
      {...rest}
    >
      <TextField
        label="Order id"
